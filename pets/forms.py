        ...
        widgets = {
            ...
            "medical_notes": forms.Textarea(
                attrs={
                    "rows": 3,
                    "placeholder": (
                        "Include allergies, medication or other care "
                        "needs. Leave blank if there are none."
                    ),
                }
            ),
            "feeding_notes": forms.Textarea(
                attrs={
                    "rows": 3,
                    "placeholder": (
                        "Include feeding times, portions or dietary "
                        "needs, or state that there are no special "
